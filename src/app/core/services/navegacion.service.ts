    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          link: '/insumos/grid',
          title: 'Insumos',
          permissionCode: 'MENU_INSUMOS',
          type: 'basic',
        },
        {
          icon: 'heroicons_outline:tag',
          id: 'insumo-tipo',
          link: '/insumo-tipo/grid',
          title: 'Tipos de Insumo',
          permissionCode: 'MENU_INSUMO_TIPO',
          type: 'basic',
        },
        {
          ...
          link: '/adhesivos/grid',
          title: 'Adhesivos',
          permissionCode: 'MENU_ADHESIVOS',
          type: 'basic',
        },
        {
          icon: 'heroicons_outline:sparkles',
          id: 'tratamientos',
          link: '/tratamientos/grid',
          title: 'Tratamientos',
          permissionCode: 'MENU_TRATAMIENTOS',
          type: 'basic',
        },
        {
