...
} from 'app/modules/abm/abm-lots/lot.interface';
...
export class LotService {
  ...
  getInformeCalidad(idCliente: number, idLote: string, observacionesInforme: string = ''): Observable<any> {
    const params = new HttpParams()
      .set('idCliente', idCliente)
      .set('idLote', idLote)
      .set('observacionesInforme', observacionesInforme);
  ...
  enviarInformePorCorreo(idCliente: number, idLote: string, archivos: any[] = [], observaciones: string = '', observacionesInforme: string = ''): Observable<any> {
    const body = {
      idCliente: idCliente,
      idLote: idLote,
